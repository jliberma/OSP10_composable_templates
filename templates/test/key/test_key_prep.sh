...
# create flavors
openstack flavor create perf.tiny --ram 512 --vcpu 1 --ephemeral 10 --private --project perf_tenant
openstack flavor create devel.tiny --ram 512 --vcpu 1 --ephemeral 10 --public
openstack flavor create perf.small --ram 512 --vcpu 2 --ephemeral 20 --private --project perf_tenant
openstack flavor create devel.small --ram 512 --vcpu 2 --ephemeral 20 --private --project dev_tenant --project perf_tenant
